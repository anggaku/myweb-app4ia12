    ...
    <div class="container">
      <div class="row align-items-center row-title">
        <div class="col-sm-3 text-center" data-aos="fade-right" data-aos-duration="1500">
            <img src="{{ asset('img/my-photo.png') }}" class="img-fluid my-photo" alt="my-photo">
        </div>
        <div class="col-sm-9 text-center" data-aos="fade-up" data-aos-duration="1500">
            <div class="my-name">Hi, I'm <strong>Angga</strong></div>
            <div class="caption">Gunadarma IT Lecturer</div>
        </div>
      </div>
    </div>
  </header>